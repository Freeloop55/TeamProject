...
<body>
    ...
    <div class="main">
        ...
        <div class="right">
	            ...
	            <form action="/bookmanagement/department/updateDepartment" class="form" method="post">
	            
	            	<div>
	                    <input type="hidden"  class="form-input" name="originalDepartmentNo" value="${originalDepartmentNo}"/>
	                </div>
	            
	                <div>
	                	院系编号
	                    <input type="text"  class="form-input" name="no" value="${department.no}"/>
	                </div>
	                <div>
						院系名称
	                    <input type="text" class="form-input" name="name" value="${department.name}"/>
	                </div>
